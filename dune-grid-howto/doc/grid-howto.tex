...
<<<<<<< HEAD:dune-grid-howto/doc/grid-howto.tex
...
>>>>>>> reverts all post 1.1.1 commits except adding a new build target for suse10.3:dune-grid-howto/doc/grid-howto.tex
