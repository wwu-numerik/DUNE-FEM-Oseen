  ...
  public:
    ...
    * velocity,rhs1 is  stored as member,no better idea
    ...
    SaddlepointInverseOperator( const StokesPassType& op,
			 ...
			 const PressureDiscreteSpaceType& pressurespc,
			 const VelocityDiscreteSpaceType& spc
...
//
    ...
    const PressureDiscreteSpaceType& pressure_space_;
    const VelocityDiscreteSpaceType& velocity_space_;
