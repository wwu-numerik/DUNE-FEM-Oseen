...
\begin{definition}\textbf{StationÃ¤res Stokes Problem}
	\label{def:stat_stokes_prob}
	\index{Stokes}
    Mit $\Omega \in  \subseteq \R^d , d = 2,3$ beschrÃ¤nkt:
...
\begin{bemerkung}
    ...
    \begin{align*}
        ...
        \mu &\in \R^{\geq 0} \\
        \int_{\partial \Omega}{g_D \cdot n \ds} &= 0 \quad\text{n Ã¤ussere Einheitsnormale}\\
    \end{align*}
...
\begin {definition}\textbf{FunktionenrÃ¤ume}\label{def:kont_funk_rï¿½ume}
    \begin{align}
...
\begin {definition}\textbf{Diskrete FunktionenrÃ¤ume}\label{def:disk_funk_rï¿½ume}
    \begin{align}
...
\begin{definition}\textbf{diskrete schwache LÃ¶sung}\label{def:disk_schw_lsg}
...
%inser normalen erklï¿½ruings bild thingy
...
\begin{definition}\textbf{Numerische FlÃ¼sse}\label{def:num_flusse}
