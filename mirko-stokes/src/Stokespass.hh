...
namespace Dune {
  ...
  public:
    ...
    // Various other types
    typedef typename DestinationType::LocalFunctionType
        LocalVeloType;
    typedef typename DiscreteModelType::SelectorType
        SelectorType;
    typedef DiscreteModelCaller< DiscreteModelType, ArgumentType, SelectorType>
...
//******** section 1
	//iterate over number of points in quadrature
