/**
 *  \brief  elementintegrators.hh
 *
 *  \todo   doc
 **/

#ifndef ELEMENTINTEGRATORS_HH
#define ELEMENTINTEGRATORS_HH

namespace Darcy
{

/**
 *  \brief  DarcyElementRhsIntegrator
 *
 *  \todo   doc
 **/
template< class ElementIntegratorTraitsImpType, class EllipticModelImpType, class DiscreteFunctionSpaceImpType >
class DarcyElementRhsIntegrator
    : public Dune::DefaultElementRhsIntegrator< ElementIntegratorTraitsImpType,
                                                EllipticModelImpType,
                                                DarcyElementRhsIntegrator< ElementIntegratorTraitsImpType, EllipticModelImpType, DiscreteFunctionSpaceImpType > >
{
    private:

        typedef ElementIntegratorTraitsImpType
            ElementIntegratorTraitsType;

        typedef EllipticModelImpType
            EllipticModelType;

        typedef DiscreteFunctionSpaceImpType
            DiscreteFunctionSpaceType;

        typedef DarcyElementRhsIntegrator< ElementIntegratorTraitsType, EllipticModelType, DiscreteFunctionSpaceType >
            ThisType;

        typedef Dune::DefaultElementRhsIntegrator<  ElementIntegratorTraitsType,
                                                    EllipticModelType,
                                                    ThisType >
            BaseType;
    ...
    public:
        ...
        DarcyElementRhsIntegrator(  EllipticModelType& ellipticModel,
                                    const DiscreteFunctionSpaceType& discreteFunctionSpace,
                                    const int verbose = 0 )
                : BaseType( ellipticModel, discreteFunctionSpace, verbose ) {}
        ...
        void addElementRhs( EntityType& entity,
                            ElementRhsType& elementRhs,
                            double coefficient = 1.0 )
        {
//            addSourceElementRhs(entity,elementRhs,coef);
//            addNeumannElementRhs(entity,elementRhs,coef);
//            addRobinElementRhs(entity,elementRhs,coef);

        }
};  // end of DarcyElementRhsIntegrator
